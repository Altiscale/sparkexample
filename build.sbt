...
// This is designed for Spark 2.1, 2.2, 2.3
...
// libraryDependencies += "local.org.apache.spark" % "spark-assembly_2.11" % "2.3.2"

// libraryDependencies += "local.org.apache.spark" % "spark-sql_2.11" % "2.3.2"

// libraryDependencies += "local.org.apache.spark" % "spark-catalyst_2.11" % "2.3.2"
