...
// libraryDependencies += "local.org.apache.spark" % "spark-assembly_2.11" % "2.1.0"

// libraryDependencies += "local.org.apache.spark" % "spark-sql_2.11" % "2.1.0"

// libraryDependencies += "local.org.apache.spark" % "spark-catalyst_2.11" % "2.1.0"
